...
class DT_Product_Block_Adminhtml_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
   ...
   protected function _prepareCollection()
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('sku', array(
            'header'    => Mage::helper('product')->__('SKUS'),
            'align'     => 'left',
            'index'     => 'sku'
        ));
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('delete', array(
             'label'    => Mage::helper('product')->__('Multiple Delete'),
