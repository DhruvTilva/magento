...
class DT_Product_Adminhtml_ProductController extends Mage_Adminhtml_Controller_Action
{
    function indexAction()
    {
        // $this->_title($this->__('Product'))->_title($this->__('Manage Products'));
        $this->loadLayout();
        $this->_addContent($this->getLayout()->createBlock('product/adminhtml_product'));
        // Mage::getModel('product/product')->getCollection();
        $this->renderLayout();
