...
class DT_Vendor_Model_Session extends Mage_Core_Model_Session_Abstract
{
    /**
     * Customer object
     *
     ...
     */
    public function setCustomer(DT_Vendor_Model_Vendor $vendor)
    {
    ...
    {
        if ($this->_vendor instanceof DT_Vendor_Model_Vendor) {
            return $this->_vendor;
        }
    ...
    public function getVendorGroupId()
    {
        ...
        return DT_Vendor_Model_Group::NOT_LOGGED_IN_ID;
    }
    ...
    public function checkVendorId($customerId)
    {
        if ($this->_isVendorIdChecked === null) {
            $this->_isVendorIdChecked = Mage::getResourceSingleton('vendor/vendor')->checkCustomerId($vendorId);
        }
    ...
    {
        $this->setId(null);
        $this->setVendorGroupId(DT_Vendor_Model_Group::NOT_LOGGED_IN_ID);
