...
class DT_Vendor_Model_Vendor extends Mage_Core_Model_Abstract
{
    /**#@+
    ...
    const EXCEPTION_INVALID_RESET_PASSWORD_LINK_VENDOR_ID = 5;
    /**#@-*/
     ...
     */
    const XML_PATH_MIN_PASSWORD_LENGTH = 'vendor/password/min_password_length';
     ...
     * @return  Mage_vendor_Model_Customer
     */
     ...
     * @return boolean
     */
    public function isAddressPrimary(DT_Vendor_Model_Address $address)
    {
        if (!$address->getId()) {
            return false;
        }
    ...
    /**
     * Change reset password link vendor Id
     *
     * Stores new reset password link vendor Id
     *
     * @param string $newResetPasswordLinkvendorId
     * @return Mage_vendor_Model_Customer
     * @throws Mage_Core_Exception
     */
    public function changeResetPasswordLinkCustomerId($newResetPasswordLinkCustomerId)
    {
        if (!is_string($newResetPasswordLinkCustomerId) || empty($newResetPasswordLinkCustomerId)) {
            throw Mage::exception(
                'Mage_Core',
                Mage::helper('vendor')->__('Invalid password reset vendor Id.'),
                self::EXCEPTION_INVALID_RESET_PASSWORD_LINK_CUSTOMER_ID
            );
        }
        $this->_getResource()->changeResetPasswordLinkVendorId($this, $newResetPasswordLinkVendorId);
        return $this;
    }
